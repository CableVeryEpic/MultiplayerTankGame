...
{
    [SerializeField] private TankInput input;
    ...
    public override void OnNetworkSpawn()
    {
        ...
        if (input == null) input = GetComponent<TankInput>();
    ...
    void FixedUpdate()
    {
        ...
        int turn = input.Turn.Value;
        int throttle = input.Throttle.Value;
        boostHeld = input.boostHeld.Value;
